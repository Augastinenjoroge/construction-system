	...
	<div class="page-wrap">
					...
					<div class="swiper-wrapper">
						<div class="hero__wrapper" style="background-image: url('assets/img/slider/1.jpg');">
							<div class="hero__inner">
								<div class="container">
									<h1 class="hero__title">How to Master Microcopy</h1>
									<p class="hero__desc">The stress and strain of life is sometimes fun. If there is any boat, it is important</p>
						...
						<div class="hero__wrapper" style="background-image: url('assets/img/slider/2.jpg');">
							<div class="hero__inner">
								<div class="container">
									<h1 class="hero__title">Design a Perfect Homepage</h1>
									<p class="hero__desc">Duis porttitor is free and needs to be fulfilled. Maecenas quis felis turpis. No one is ugly but advocating</p>
						...
						<div class="hero__wrapper" style="background-image: url('assets/img/slider/3.jpg');">
							<div class="hero__inner">
								<div class="container">
									...
									<p class="hero__desc">I'm talking about the element of the urn augue, the eu porta pure gravida in. To-morrow will follow, the course of the course</p>
						...
						<div class="hero__wrapper" style="background-image: url('assets/img/slider/4.jpg');">
							<div class="hero__inner">
								<div class="container">
									...
									<p class="hero__desc">For he receives nothing but laughter, and the fear of the airline employee. The boat takes up that which the school takes</p>
					...
					<div class="row">
						<div class="col-lg-6 ">
							<div class="mb-30">
								...
								<p>It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularized in the 1960s with the release of Letraset sheets containing Quality Builders passages,</p><br><br><a class="btn btn-primary btn-outline" href="#">More about us</a>
							</div>
						</div>
						<div class="col-lg-6 ">
							...
							<div class="about"><img src="assets/img/about/2.jpg" alt="" />
								...
								<blockquote class="quote-02 about-quote">
									<p class="quote-02__text">Quality Builders should be a team, followed by a coaching team. As laoreet as lake from tincidunt. Quisque luctus nibh ague, not ultrices arcu molestie in The price of the bed in the time is full</p>
					...
					<div class="row row-eq-height">
						<div class="col-sm-6 col-md-6 col-lg-4 ">
							...
							<div class="services">
								...
								<div class="services__desc">I'm talking about the element of the urn augue, the eu porta pure gravida in. To-morrow it will be followed, and the course of the vestibule, the ligula is pure</div>
						...
						<div class="col-sm-6 col-md-6 col-lg-4 ">
							...
							<div class="services">
								...
								<div class="services__desc">Quality Builders should be a team, followed by a coaching team. As laoreet as lake from tincidunt. Everyone mourns the news, no</div>
						...
						<div class="col-sm-6 col-md-6 col-lg-4 ">
							...
							<div class="services">
								...
								<div class="services__desc">Duis porttitor is free and needs to be fulfilled. Maecenas quis felis turpis. There is no one who is ugly, but it is necessary to advertise the protein or at least</div>
						...
						<div class="col-sm-6 col-md-6 col-lg-4 ">
							...
							<div class="services">
								...
								<div class="services__desc">In fact, the player does not want to decorate the league, but just cartoons and football. Some adorn the bed as a quiver. It was something</div>
						...
						<div class="col-sm-6 col-md-6 col-lg-4 ">
							...
							<div class="services">
								...
								<h2 class="services__title"><a href="#">Construction Consultant</a></h2>
								<div class="services__desc">The stress and strain of life is sometimes fun. If there is any boat, it is important to decorate the property free of charge.</div>
						...
						<div class="col-sm-6 col-md-6 col-lg-4 ">
							...
							<div class="services">
								...
								<div class="services__desc">The whole body is placed in the urn and not the rhonus. But he just wants to, Lacinia will not invest in wisdom, he will laugh with arrows..</div>
									...
									<div class="grid-item__inner">
										<div class="grid-item__content-wrapper">
											...
											<div class="gallery gallery--grid">
												<div class="gallery__image bg-image" style="background-image: url(assets/img/gallery/9.jpg);"><img src="assets/img/gallery/9.jpg" alt="How to Create and" /><a class="gallery__overlay mfp-image" href="assets/img/gallery/9.jpg" data-effect="mfp-zoom-in" title="Design a Perfect">
														<div class="md-tb">
						...
						<div class="swiper-wrapper">
							<div class="testimonial-item">
								...
								<blockquote class="quote">
									<p>For he receives nothing but laughter, and the fear of the airline employee. The price of the boat is what it costs. Maecenas ultrices, lacus as the greatest accumsan, hateful propaganda,</p>
							...
							<div class="testimonial-item">
								...
								<!-- quote -->
								<blockquote class="quote">
									<p>Maecenas lorem ex, Euismod does not need a pillow, as easy as a lion. Everyone invests pure in and is not made to decorate. For it is just great. Some venomous hatred before, not euismod augue</p>
								</blockquote><!-- End / quote -->
							...
							<div class="testimonial-item">
								...
								<!-- quote -->
								<blockquote class="quote">
									<p>The whole body is placed in the urn and not the rhonus. But he just wants to, Lacinia will not invest in wisdom, he will laugh with arrows. There is no mass-produced chocolate in the package. Yes</p>
								</blockquote><!-- End / quote -->
							...
							<div class="testimonial-item">
								...
								<!-- quote -->
								<blockquote class="quote">
									<p>Mauris Lacinia's venomous pain is a lot to draw. There is no complete expectation. But the makeup of the soccer team is a career. It was a weekend. It is not a real estate</p>
								</blockquote><!-- End / quote -->
					...
					<div class="row">
							...
							<div class="team">
								...
								<div class="team__body">
									<div class="team__user">
										<h4 class="team__name">Sean Coleman</h4><span class="team__work">Photography</span>
									</div>
									<p class="team__text">In fact, the player does not want to decorate the league, but just cartoons and football. Some decorate the bed as</p>
								</div>
							</div><!-- End / team -->
						...
						<div class="col-sm-6 col-md-6 col-lg-3 ">
							...
							<div class="team">
								...
								<div class="team__body">
									<div class="team__user">
										<h4 class="team__name">Daniel Ramirez</h4><span class="team__work">CEO &amp; Founder</span>
									</div>
									<p class="team__text">It's not just a casino, or my time. There is nothing easy. Fusce at the tortor arc. Stress</p>
								</div>
							</div><!-- End / team -->
						...
						<div class="col-sm-6 col-md-6 col-lg-3 ">
							...
							<div class="team">
								...
								<div class="team__body">
									<div class="team__user">
										<h4 class="team__name">Bryan Ryan</h4><span class="team__work">Designer</span>
									</div>
									<p class="team__text">The whole body is placed in the urn and not the rhonus. But he wants to be just, not wise</p>
								</div>
							</div><!-- End / team -->
						...
						<div class="col-lg-9  col-lg-push-3">
							<div class="main-content">
								<div class="row">
									...
									<div class="col-lg-6 ">
										<div class="contact-gmap"><iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d15956.047394462112!2d36.66672105!3d-1.1520278!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2ske!4v1733344620400!5m2!1sen!2ske"  width="100%" height="500" frameborder="0" style="border:0" allowfullscreen></iframe></div>
									</div>
								</div>
							</div>
						</div>
						<div class="col-lg-3  col-lg-pull-9">
							<div class="sidebar">
								...
								<section class="widget">
									...
									<p class="mb-30">Quality Builders is important, and the developer will pursue it. Who are they for? And she hates, and nothing often. And it shall come to pass, that there may be any one who hinders us from assuming the right, and they do not know whether to flee or to enter.</p>

									<!--  -->
									<div>
										<div class="widget-contact__item"><span class="widget-contact__title">Tel:</span>
											<p class="widget-contact__text">+254 712 3456</p>
										</div>
		...
		<footer class="footer-01 md-skin-dark">
					...
					<div class="row">
						<div class="col-md-6 col-lg-3 ">
							...
							<section class="widget">
								...
								<p> Quality Builders is important, and the developer will pursue it. Who, by the nature of things, pleases some labor, and therefore no one attains the pleasure of those who praise him, so that I may reveal these things themselves?</p>
							</section><!-- End / widget -->
						...
						<div class="col-md-6 col-lg-3 ">
							...
							<section class="widget">
								...
								<!-- widget-tag -->
								<!-- <div class="widget-tag"><a href="#">Dress</a><a href="#">Mini</a><a href="#">Skate Animal</a><a href="#">Quality Builders</a><a href="#">Litterature</a><a href="#">Foreign</a><a href="#">Dessert</a><a href="#">Food</a><a href="#">Litterature</a><a href="#">Foreign</a><a href="#">Dessert</a><a href="#">Litterature</a><a href="#">Food</a>
								</div> --><!-- End /  widget-tag -->
						...
						<div class="col-lg-3 ">
							...
							<section class="widget">
								...
								<p> Quality Builders is a pain to be followed</p>
			...
			<div class="copyright-01 md-text-center">
				<div class="container">
					<p class="copyright-01__copy"> &copy; </p>
				</div>
